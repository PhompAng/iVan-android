...
public class RoundedCornersTransformation implements Transformation<Bitmap> {
	...
	private static final String ID = "com.firebaseapp.ivan.util.glide.RoundedCornersTransformation";
	...
	@Override public String toString() {
		return "RoundedCornersTransformation(radius=" + mRadius + ", margin=" + mMargin + ", diameter="
	...
	public boolean equals(Object obj) {
		if (obj instanceof RoundedCornersTransformation) {
			RoundedCornersTransformation transformation = (RoundedCornersTransformation) obj;
			return mRadius == transformation.mRadius;
		}
		return false;
	}
}
